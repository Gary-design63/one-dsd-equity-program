...
const recentActivity = [
  { source: "Equity Assist", action: "Generated Olmstead progress brief", time: "12 min ago", status: "healthy" as HealthTone },
  { source: "Equity Assist", action: "Analyzed service access across communities", time: "34 min ago", status: "healthy" as HealthTone },
  { source: "Learning", action: "Created cultural responsiveness module 3", time: "1 hr ago", status: "healthy" as HealthTone },
  { source: "Community Voice", action: "Drafted newsletter for review", time: "2 hr ago", status: "watch" as HealthTone },
  { source: "KPIs", action: "Calculated 2026 rate impacts by county", time: "3 hr ago", status: "healthy" as HealthTone },
];
...
const logicModelSteps = [
  {
    title: "Inputs",
    items: ["150–180 DSD staff", "Operations platform", "30 community profiles", "Training portfolio", "Enterprise-ready frontend"],
  },
  {
    title: "Activities",
          ...
          <div className="max-w-3xl space-y-3">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground md:text-[15px]">
                <EditableText id="dashboard.subtitle" defaultValue="One DSD People and Culture Program · Minnesota Department of Human Services" />
              </p>
            </div>
        ...
        <div className="mt-5 grid gap-3 lg:grid-cols-[minmax(0,1fr)_320px]">
          ...
          <div className="rounded-2xl border border-white/50 bg-white/72 p-4 backdrop-blur dark:border-white/10 dark:bg-white/5">
            ...
            <div className="mt-4 flex gap-2">
              ...
              <Link to="/approval-queue" className="flex-1">
                <Button variant="outline" className="w-full rounded-xl" data-testid="link-dashboard-queue">
                  Approval queue
                </Button>
              </Link>
            </div>
          ...
          <Card className="panel-card">
            <CardHeader className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <CardDescription>Latest outputs across all modules with quality-state indicators.</CardDescription>
              </div>
              <Link to="/approval-queue" className="text-sm font-medium text-[hsl(var(--mn-blue))] hover:underline" data-testid="link-approval-queue-view-all">
                View approval queue
              </Link>
            </CardHeader>
            <CardContent className="space-y-3">
              {recentActivity.map((activity) => {
                ...
                return (
                  <div key={`${activity.source}-${activity.action}`} className="flex flex-col gap-3 rounded-2xl border border-border/60 bg-card px-4 py-3 md:flex-row md:items-center md:justify-between">
                    <div>
