    ...
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
      <div>
        <h1 className="text-2xl font-bold text-[#003865]" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>
          <EditableText field="kb-title" defaultValue="Knowledge Base" />
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          <EditableText field="kb-subtitle" defaultValue="Governing documents, equity tools, and program references organized by authority level" />
        </p>
      </div>
